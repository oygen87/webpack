...
module.exports = class ModuleTemplate {
	constructor(runtimeTemplate, type) {
		...
		this.hooks = {
			...
			content: new SyncWaterfallHook(["source", "module", "options"]),
			/** @type {SyncWaterfallHook<Source, Module, RenderContext>} */
			module: new SyncWaterfallHook(["source", "module", "options"]),
			/** @type {SyncWaterfallHook<Source, Module, RenderContext>} */
			render: new SyncWaterfallHook(["source", "module", "options"]),
			/** @type {SyncWaterfallHook<Source, Module, RenderContext>} */
			package: new SyncWaterfallHook(["source", "module", "options"]),
